    ...
    def parse(self, response):
        ...
        if f_name:
            ...
            if fund_name:
                ...
                core_data = []
                for i in range(0, len(table_body_data) - 4):
                    if not table_body_data[i] == "\n":
            ...
            # next_page = response.css("a.robo_medium")
            # if response.css("section.histroic_return_tabs") is not None:
